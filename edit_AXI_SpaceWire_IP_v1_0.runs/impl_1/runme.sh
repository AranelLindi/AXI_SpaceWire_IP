...
HD_PWD='/home/stl56jc/Dokumente/Code/axi_spw_ip_repo/edit_AXI_SpaceWire_IP_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_SpaceWire_IP_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AXI_SpaceWire_IP_v1_0.tcl -notrace
