...
proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: AXI_SpaceWire_IP_0, and set properties
	set AXI_SpaceWire_IP_0 [ create_bd_cell -type ip -vlnv user.org:user:AXI_SpaceWire_IP:1.0 AXI_SpaceWire_IP_0 ]
	...
	# Connect all clock & reset of AXI_SpaceWire_IP_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins AXI_SpaceWire_IP_0/S02_AXI_REG]
	connect_bd_net [get_bd_pins AXI_SpaceWire_IP_0/s02_axi_reg_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AXI_SpaceWire_IP_0/s02_axi_reg_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins AXI_SpaceWire_IP_0/S00_AXI_TX]
	connect_bd_net [get_bd_pins AXI_SpaceWire_IP_0/s00_axi_tx_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AXI_SpaceWire_IP_0/s00_axi_tx_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M02_AXI] [get_bd_intf_pins AXI_SpaceWire_IP_0/S01_AXI_RX]
	connect_bd_net [get_bd_pins AXI_SpaceWire_IP_0/s01_axi_rx_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AXI_SpaceWire_IP_0/s01_axi_rx_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to AXI_SpaceWire_IP_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/AXI_SpaceWire_IP_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_AXI_SpaceWire_IP_0_S00_AXI_TX_* ]]
	puts $fp "set s00_axi_tx_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_AXI_SpaceWire_IP_0_S01_AXI_RX_* ]]
	puts $fp "set s01_axi_rx_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_AXI_SpaceWire_IP_0_S02_AXI_REG_* ]]
	puts $fp "set s02_axi_reg_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:AXI_SpaceWire_IP:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/AXI_SpaceWire_IP_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "AXI_SpaceWire_IP_v1_0_hw_${i}"
